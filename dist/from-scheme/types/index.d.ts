...
export declare type FieldTransformer = (fields: Array<InferField>, resources: IResourceItem[], resource: IResourceItem, record: Record<string, unknown>, infer: FieldInferencer, type: "list" | "show" | "edit" | "create") => Array<InferField>;
export declare type FieldInferencer = (key: string, props: unknown, infer: FieldInferencer, type?: "list" | "show" | "edit" | "create") => InferField | null | false;
...
export declare type SchemaInferencerResultComponent = React.FC<InferencerComponentProps>;
export declare type CreateSchemaInferencer = (config: CreateSchemaInferencerConfig) => SchemaInferencerResultComponent;
