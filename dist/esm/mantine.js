...
var ErrorComponent = /* @__PURE__ */ __name(({
  ...
  if (error) {
    return /* @__PURE__ */ React6.createElement(Center, { style: { minHeight: 300 } }, /* @__PURE__ */ React6.createElement(Alert, { title: "Error", color: "red", icon: /* @__PURE__ */ React6.createElement(IconAlertCircle, null) }, /* @__PURE__ */ React6.createElement("div", { dangerouslySetInnerHTML: { __html: error ?? "" } })));
  }
  return null;
}, "ErrorComponent");
...
var LoadingComponent = /* @__PURE__ */ __name(() => {
  return /* @__PURE__ */ React7.createElement(LoadingOverlay, { visible: true });
}, "LoadingComponent");
...
import { ScrollArea, Table, Pagination, Group as Group2, Image as Image2 } from "@mantine/core";
...
var ListInferencer = createInferencer({
  ...
  additionalScope: [
    ...
    [
      "@mantine/core",
      "MantineCore",
      { ScrollArea, Table, Pagination, Group: Group2, Image: Image2 }
    ],
...
import { Edit, useForm as useForm2, useSelect as useSelect2 } from "@refinedev/mantine";
import {
...
var EditInferencer = createInferencer({
  type: "edit",
  additionalScope: [
    ["@refinedev/mantine", "RefineMantine", { Edit, useForm: useForm2, useSelect: useSelect2 }],
    [
      "@mantine/core",
      "MantineCore",
      {
...
export {
  ...
  renderer3 as MantineCreateRenderer,
  EditInferencer as MantineEditInferencer,
  renderer4 as MantineEditRenderer,
  MantineInferencer,
  ListInferencer as MantineListInferencer,
  renderer2 as MantineListRenderer,
