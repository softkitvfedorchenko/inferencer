...
import { useResource as useResource4 } from "@refinedev/core";
...
import { useResource as useResource2, TranslationContext } from "@refinedev/core";
...
var toPlural = /* @__PURE__ */ __name((str = "") => {
  return pluralize2.isPlural(str) ? str : pluralize2.plural(str);
}, "toPlural");
...
var resourceFromInferred = /* @__PURE__ */ __name((field, resources) => {
  ...
  const resource = resources.find((el) => {
    ...
    return el.name === stripped || el.name === (pluralize3.isPlural(stripped) ? stripped : pluralize3.plural(stripped)) || el.name === (pluralize3.isSingular(stripped) ? stripped : pluralize3.singular(stripped));
  });
  return resource;
...
var componentName = /* @__PURE__ */ __name((resourceName, type, fallbackResourceName = "Inferred") => {
  ...
  const singular = pluralize4.singular(sanitized);
...
var dateInfer = /* @__PURE__ */ __name((key, value) => {
  const isDateField = dateSuffixRegexp.test(key) && dayjs(value).isValid();
...
var InferencerLiveContext = React.createContext(
  {}
);
var LiveComponent = /* @__PURE__ */ __name(({
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    !fetchError && /* @__PURE__ */ React.createElement(LivePreview, { Context: InferencerLiveContext }),
    /* @__PURE__ */ React.createElement(ErrorComponentWithError, null)
  );
}, "LiveComponent");
...
var SharedCodeViewer = /* @__PURE__ */ __name(({ code: rawCode, loading }) => {
  const code = React2.useMemo(() => {
    return prettierFormat(rawCode ?? "");
  }, [rawCode]);
  const [settled, setSettled] = React2.useState(false);
  const [isModalVisible, setIsModalVisible] = React2.useState(false);
  const [isVisible, setIsVisible] = React2.useState(false);
  const [isColumn, setIsColumn] = React2.useState(false);
  const [isModalButtonHover, setIsModalButtonHover] = React2.useState(false);
  React2.useEffect(() => {
    if (!loading) {
  ...
  if (code && !loading) {
    return /* @__PURE__ */ React2.createElement(React2.Fragment, null, isVisible && /* @__PURE__ */ React2.createElement(
      "div",
      {
      ...
      /* @__PURE__ */ React2.createElement(
        ...
        /* @__PURE__ */ React2.createElement(
          ...
          /* @__PURE__ */ React2.createElement("div", null, /* @__PURE__ */ React2.createElement(InfoIcon, null)),
          /* @__PURE__ */ React2.createElement(
            "div",
            {
              style: {
            ...
            /* @__PURE__ */ React2.createElement(
              ...
              " ",
              /* @__PURE__ */ React2.createElement("span", { style: { fontWeight: 600 } }, "it's not intended to be used on production.")
            )
          )
        ),
        /* @__PURE__ */ React2.createElement("div", null, /* @__PURE__ */ React2.createElement(
          ...
          /* @__PURE__ */ React2.createElement("span", null, "Show the auto-generated code")
        ))
      )
    ), /* @__PURE__ */ React2.createElement(
      CodeModal,
...
var CodeModal = /* @__PURE__ */ __name(({
  ...
  const [isCopyHover, setIsCopyHover] = React2.useState(false);
  const [isCloseHover, setIsCloseHover] = React2.useState(false);
  const [isLearnMoreHover, setIsLearnMoreHover] = React2.useState(false);
  React2.useEffect(() => {
  ...
  const title = /* @__PURE__ */ React2.createElement(
    "div",
    {
      style: {
        display: "flex",
  ...
  const highlight = /* @__PURE__ */ React2.createElement(
    "div",
    {
      style: {
        fontSize: "13px",
    ...
    /* @__PURE__ */ React2.createElement(
      ...
      ({
        ...
        tokens.map((line, i) => /* @__PURE__ */ React2.createElement(
          "div",
          {
            key: i,
            ...getLineProps({
          ...
          line.map((token, key) => /* @__PURE__ */ React2.createElement(
            "span",
            {
              key,
              ...getTokenProps({
  ...
  const buttons = /* @__PURE__ */ React2.createElement(
    "div",
    {
      style: {
        display: "flex",
    ...
    /* @__PURE__ */ React2.createElement(
      ...
      /* @__PURE__ */ React2.createElement("span", null, "Copy Generated Code"),
      /* @__PURE__ */ React2.createElement(
        "div",
        {
          style: {
        ...
        /* @__PURE__ */ React2.createElement("span", null, "Copied!")
      )
    ),
    /* @__PURE__ */ React2.createElement(
      "a",
      ...
      /* @__PURE__ */ React2.createElement("span", null, "Learn more about inferencer")
    )
  );
...
var InfoIcon = /* @__PURE__ */ __name((props) => /* @__PURE__ */ React2.createElement(
  "svg",
  {
...
var OpenIcon = /* @__PURE__ */ __name((props) => /* @__PURE__ */ React2.createElement(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    width: 16,
...
var CloseIcon = /* @__PURE__ */ __name((props) => /* @__PURE__ */ React2.createElement(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    width: 32,
...
var ClipboardIcon = /* @__PURE__ */ __name((props) => /* @__PURE__ */ React2.createElement(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    width: 20,
  ...
  /* @__PURE__ */ React2.createElement("path", { fill: "currentColor", d: "M13 4a1 1 0 1 1 0 2h-2a1 1 0 1 1 0-2h2Z" })
), "ClipboardIcon");
...
var useInferFetch = /* @__PURE__ */ __name((type, resourceNameOrRouteName, idFromProps, meta) => {
  ...
  const [datas, setDatas] = React3.useState(void 0);
  const [initial, setInitial] = React3.useState(true);
  const [loading, setLoading] = React3.useState(false);
  const resolver = React3.useCallback(
    async (recordItemId) => {
      var _a;
...
import { useDataProvider as useDataProvider2 } from "@refinedev/core";
...
var useRelationFetch = /* @__PURE__ */ __name(({
  ...
  const dataProvider = useDataProvider2();
  const [updatedFields, setUpdatedFields] = React4.useState([]);
  const [initial, setInitial] = React4.useState(true);
  const [loading, setLoading] = React4.useState(false);
  const resolver = React4.useCallback(
    async (allFields) => {
        ...
        const promises = allFields.map(async (field) => {
          ...
          if (field && (field.relation || field.canRelation)) {
            if (record) {
              ...
              )[0] : field.accessor ? get(record[field.key], field.accessor) : record[field.key];
...
var createInferencer = /* @__PURE__ */ __name(({
  ...
  const Inferencer = /* @__PURE__ */ __name(({
    ...
    var _a, _b;
    const { resource, resources } = useResource2(resourceName);
    const { i18nProvider } = useContext(TranslationContext);
    const { resource: resourceFromURL } = useResource2();
    const {
      data: record,
      datas: records,
    ...
    const [rawResults, recordInUse] = React5.useMemo(() => {
    ...
    const clearedFields = React5.useMemo(() => {
      const cleanFields = [];
    ...
    return /* @__PURE__ */ React5.createElement(React5.Fragment, null, LoadingComponent2 && (recordLoading || relationLoading) && /* @__PURE__ */ React5.createElement(LoadingComponent2, null), !recordLoading && !relationLoading && /* @__PURE__ */ React5.createElement(React5.Fragment, null, /* @__PURE__ */ React5.createElement(
      LiveComponent,
      {
    ...
    ), typeof CodeViewerComponent !== "undefined" && !hiddenCodeViewer ? /* @__PURE__ */ React5.createElement(
      CodeViewerComponent,
      {
  ...
  const InferencerComponent = /* @__PURE__ */ __name(({
    ...
    const { resource: resourceItem } = useResource2(resource ?? name);
...
var ErrorComponent = /* @__PURE__ */ __name(({
  ...
  if (error) {
    return /* @__PURE__ */ React6.createElement(Row, { justify: "center", align: "middle", style: { minHeight: "200px" } }, /* @__PURE__ */ React6.createElement(Col, null, /* @__PURE__ */ React6.createElement(
      Alert,
      {
        message: "Error",
...
import { Spin, Row as Row2, Col as Col2 } from "antd";
var LoadingComponent = /* @__PURE__ */ __name(() => {
  return /* @__PURE__ */ React7.createElement(Row2, { justify: "center", align: "middle", style: { minHeight: "300px" } }, /* @__PURE__ */ React7.createElement(Col2, null, /* @__PURE__ */ React7.createElement(Spin, { size: "large" })));
}, "LoadingComponent");
...
import {
  useTable,
  List,
  TagField as TagField2,
  ImageField as ImageField2,
  EmailField as EmailField2,
  UrlField as UrlField2,
  BooleanField as BooleanField2,
  DateField as DateField2,
  MarkdownField as MarkdownField2,
  EditButton,
  ShowButton,
  DeleteButton
} from "@refinedev/antd";
  ...
  operationKeys.forEach(([operationKey, crudKey]) => {
    if (operationKey in resourceSchema) {
      ...
      if (requestRef) {
        ...
        set(crudSchemas, `${crudKey}.request`, cloneDeep(scheme_default.components.schemas[requestRefName]));
      }
      ...
      if (responseRef) {
        ...
        set(crudSchemas, `${crudKey}.response`, cloneDeep(scheme_default.components.schemas[responseRefName]));
      }
    }
  });
  return crudSchemas;
...
import { useResource as useResource3, TranslationContext as TranslationContext2 } from "@refinedev/core";
...
var createSchemaInferencer = /* @__PURE__ */ __name(({
  ...
  const Inferencer = /* @__PURE__ */ __name(({
    ...
    const { resource, resources } = useResource3(resourceName);
    console.log("resource: ", resource);
    const { resource: resourceFromURL } = useResource3();
    console.log("resourceFromURL: ", resourceFromURL);
    const { i18nProvider } = useContext2(TranslationContext2);
  ...
  const InferencerComponent = /* @__PURE__ */ __name(({
    ...
    const { resource: resourceItem } = useResource3(resource ?? name);
...
import { Edit, useForm as useForm2, useSelect as useSelect2, getValueFromEvent as getValueFromEvent2 } from "@refinedev/antd";
import { Form as Form2, Input as Input2, Select as Select2, Upload as Upload2, Checkbox as Checkbox2, DatePicker as DatePicker2 } from "antd";
...
var EditInferencer = createInferencer({
  ...
  additionalScope: [
    [
      "@refinedev/antd",
      "RefineAntd",
      { Edit, useForm: useForm2, useSelect: useSelect2, getValueFromEvent: getValueFromEvent2 }
    ],
    ["dayjs", "dayjs", dayjs3, true],
    [
      "antd",
      "AntdPackage",
      { Form: Form2, Input: Input2, Select: Select2, Upload: Upload2, Checkbox: Checkbox2, DatePicker: DatePicker2 }
    ]
  ],
  codeViewerComponent: SharedCodeViewer,
  loadingComponent: LoadingComponent,
...
var AntdInferencer = /* @__PURE__ */ __name(({
  ...
  const { action, id, ...rest } = useResource4();
  console.log("rest: ", rest);
  switch (actionFromProps ?? action) {
    case "show":
      return /* @__PURE__ */ React9.createElement(ShowInferencer, { ...props, id: idFromProps ?? id });
    case "create":
      return /* @__PURE__ */ React9.createElement(CreateInferencer, { ...props, id: idFromProps ?? id });
    case "edit":
      return /* @__PURE__ */ React9.createElement(EditInferencer, { ...props, id: idFromProps ?? id });
    default:
      return /* @__PURE__ */ React9.createElement(ListInferencer, { ...props, id: idFromProps ?? id });
  }
}, "AntdInferencer");
export {
  CreateInferencer as AntdCreateInferencer,
  renderer3 as AntdCreateRenderer,
  EditInferencer as AntdEditInferencer,
  renderer4 as AntdEditRenderer,
  AntdInferencer,
  ListInferencer as AntdListInferencer,
  renderer2 as AntdListRenderer,
