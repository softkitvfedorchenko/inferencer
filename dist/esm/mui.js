...
var ErrorComponent = /* @__PURE__ */ __name(({
  ...
  if (error) {
    return /* @__PURE__ */ React6.createElement(
      ...
      /* @__PURE__ */ React6.createElement(Alert, { severity: "error" }, /* @__PURE__ */ React6.createElement(AlertTitle, null, "Error"), /* @__PURE__ */ React6.createElement("div", { dangerouslySetInnerHTML: { __html: error ?? "" } }))
    );
  }
  return null;
}, "ErrorComponent");
...
var LoadingComponent = /* @__PURE__ */ __name(() => {
  return /* @__PURE__ */ React7.createElement(
    ...
    /* @__PURE__ */ React7.createElement(CircularProgress, { size: "large" })
  );
}, "LoadingComponent");
...
var CreateInferencer = createInferencer({
  ...
  additionalScope: [
    ...
    [
      "@mui/material",
      "MuiMaterial",
      { Box: Box3, Autocomplete, TextField, Checkbox: Checkbox2, FormControlLabel }
    ],
...
import { Edit, useAutocomplete as useAutocomplete2 } from "@refinedev/mui";
...
var EditInferencer = createInferencer({
  type: "edit",
  additionalScope: [
    ["@refinedev/mui", "RefineMui", { Edit, useAutocomplete: useAutocomplete2 }],
    ["@refinedev/react-hook-form", "RefineReactHookForm", { useForm: useForm2 }],
    [
      "@mui/material",
      "MuiMaterial",
      { Box: Box4, Autocomplete: Autocomplete2, TextField: TextField2, Checkbox: Checkbox3, FormControlLabel: FormControlLabel2 }
    ],
    ["react-hook-form", "ReactHookForm", { Controller: Controller2 }]
  ],
  codeViewerComponent: SharedCodeViewer,
  loadingComponent: LoadingComponent,
  errorComponent: ErrorComponent,
...
var MuiInferencer = /* @__PURE__ */ __name(({
  ...
  const { action, id } = useResource3();
  switch (actionFromProps ?? action) {
    case "show":
      return /* @__PURE__ */ React8.createElement(ShowInferencer, { ...props, id: idFromProps ?? id });
    case "create":
      return /* @__PURE__ */ React8.createElement(CreateInferencer, { ...props, id: idFromProps ?? id });
    case "edit":
      return /* @__PURE__ */ React8.createElement(EditInferencer, { ...props, id: idFromProps ?? id });
    default:
      return /* @__PURE__ */ React8.createElement(ListInferencer, { ...props, id: idFromProps ?? id });
  }
}, "MuiInferencer");
export {
  CreateInferencer as MuiCreateInferencer,
  renderer3 as MuiCreateRenderer,
  EditInferencer as MuiEditInferencer,
  renderer4 as MuiEditRenderer,
  MuiInferencer,
  ListInferencer as MuiListInferencer,
  renderer2 as MuiListRenderer,
